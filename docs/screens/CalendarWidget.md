...
- **Actualización:** El widget actualiza sus datos en segundo plano mediante `AlarmManager` usando `setAndAllowWhileIdle` cada 15 minutos para asegurar precisión incluso en modo Doze. Actualiza la lista con `notifyAppWidgetViewDataChanged`.
